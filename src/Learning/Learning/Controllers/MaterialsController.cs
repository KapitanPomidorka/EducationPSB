...
namespace Learning.Controllers
{
    ...
    public class MaterialsController : ControllerBase
    {
        ...
        public MaterialsController(LearningDBContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Materials/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Materials>> GetMaterials(Guid id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutMaterials(Guid id, Materials materials)
        {
            if (id != materials.Id)
            {
                return BadRequest();
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteMaterials(Guid id)
        {
            var materials = await _context.Materials.FindAsync(id);
            if (materials == null)
            {
        ...
        private bool MaterialsExists(Guid id)
        {
